...
import requests
from utilities import serialize_objects
from models import *
import unittest
...
class Test_Api(TestCase):
    ...
    def test_get_womenClothes_pagination(self, page=1, qtd_per_page=10):
        pass

    def test_get_specific_product(self, page=1, qtd_per_page=10):
        pass
